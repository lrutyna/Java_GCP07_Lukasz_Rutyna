...
import gui.CustomBarChart;
import gui.CustomGuiLoggerView;
import gui.CustomTabPane;
import gui.CustomTableView;
...
public class CrawlerTask extends Task<ObservableList<Student>> {
	...
	// konstruktor 
	public CrawlerTask(CustomTabPane pane) {
		this.tableView = pane.getTableView();
		this.chart = pane.getChart();
		this.logs = pane.getLogs();
	}
